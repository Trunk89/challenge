...
module.exports = function (grunt) {
    ...
    var seleniumUrl = grunt.option('baseUrl') || 'http://localhost:8081/challenge/min/';
    ...
    grunt.initConfig({
        ...
        concat: {
            app: {
                src: [
                    ...
                    '<%= path %>app/components/word_cloud/controller.js',
                    '<%= path %>app/components/word_cloud/directive.js',
                    '<%= path %>app/components/details/controller.js',
                    '<%= path %>app/components/details/directive.js',
                    '<%= path %>app/components/details/services.js',
                ...
                dest: '<%= tempPath %>challenge.min.js'
            },
            vendor: {
                src: [
            ...
            css: {
                src: [
                    ...
                    '<%= path %>assets/css/details.css',
                    '<%= path %>assets/css/word_cloud.css',
                    '<%= path %>assets/css/desktop.css'
                ],
                dest: '<%= tempPath %>assets/css/challenge.min.css'
            }
        },
        uglify: {
            my_target: {
                files: {
                    'min/challenge.min.js': ['<%= tempPath %>challenge.min.js'],
        ...
        cssmin: {
            ...
            target: {
                files: {
                    'min/assets/css/challenge.min.css': ['<%= tempPath %>assets/css/challenge.min.css']
                }
            }
        },
        useminPrepare: {

describe("[common services]", function () {
    ...
    describe("Ajax", function () {
        ...
        it("should make a successful ajax call to api", function () {
            ...
            $httpBackend.whenGET('../api/challenge.api.json').respond(200, {user: 'Adam'});

            Ajax.get({url: '../api/challenge.api.json', success: dataResponse, error: dataResponse});
        ...
        it("should make an ajax call to api resulting in error", function () {
            ...
            $httpBackend.whenGET('../api/challenge.api.json').respond(500);
